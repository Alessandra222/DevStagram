    ...
    <body class="bg-gray-300">
        <header class="p-5 border-b bg-white shadow">
            ...
            <nav class="flex gap-4 items-center">
                <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 round text-sm uppercase font-bold cursor-pointer" href="{{route("posts.create")}}">
                ...
                <form method="POST" action="{{route('logout')}}">
                    @csrf
                    <button type="submit" class="font-bold uppercase text-gray-600 text-sm cursor-pointer" href="{{route('logout')}}">
                    Cerrar sesion
                    </button>
                </form>
          </nav>
