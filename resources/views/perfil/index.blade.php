            ...
            <form method="POST" action="{{route('perfil.store')}}" enctype="multipart/form-data" class="mt-10 md:mt-0">
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        name="username"
                        type="text"
                        placeholder="Tu Nombre de Usuario, please"
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="password"
                        placeholder="Ingresa Tu Password Anterior"
                        class="border p-3 w-full rounded-lg @error('current_password') border-red-500
                        @enderror"/>
